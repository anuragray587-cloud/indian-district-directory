...
import bhojpurData from "@/data/districts/bihar/bhojpur.json";
import buxarData from "@/data/districts/bihar/buxar.json";
import eastChamparanData from "@/data/districts/bihar/east-champaran.json";
import gayaData from "@/data/districts/bihar/gaya.json";
import gopalganjData from "@/data/districts/bihar/gopalganj.json";
import jamuiData from "@/data/districts/bihar/jamui.json";
import jehanabadData from "@/data/districts/bihar/jehanabad.json";
...
export function getDistrictData(
  ...
  if (district === "bhojpur") {
    return bhojpurData as DistrictData;
  }
  if (district === "buxar") {
    return buxarData as DistrictData;
  }
  if (district === "east-champaran") {
    return eastChamparanData as DistrictData;
  }
  if (district === "gaya") {
    return gayaData as DistrictData;
  }
  if (district === "gopalganj") {
    return gopalganjData as DistrictData;
  }
  if (district === "jamui") {
    return jamuiData as DistrictData;
  }
  if (district === "jehanabad") {
    return jehanabadData as DistrictData;
  }
}
